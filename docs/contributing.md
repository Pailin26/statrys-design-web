...
2. Add `semantic/<name>.json` in the **statrys-tokens** repo — see "Component-level
...
in exactly one place: statrys-tokens' `semantic/<component-name>.json`. The
...
1. Primitive values go in `primitives/`, semantic mappings in `semantic/`
